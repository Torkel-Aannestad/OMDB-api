...
func main() {
	...
	mailtrapUsername := os.Getenv("MAILTRAP_USERNAME_PROD")
	mailtrapPassword := os.Getenv("MAILTRAP_PASSWORD_PROD")
	...
	//Mailer sandbox.smtp.mailtrap.io
	flag.StringVar(&cfg.smtp.host, "smtp-host", "live.smtp.mailtrap.io", "host")
